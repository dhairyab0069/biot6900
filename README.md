# BIOT 6900 — Coursework Repository

Dhairya Bhatia (bhatia.dh@northeastern.edu)

This repo holds my notebooks for BIOT 6900. Right now it contains Module 1 only.
...
**Part D — Load sample data.** Not done yet. The cell still points at the placeholder path `data/TODO_assigned_file.csv` and raises a `FileNotFoundError`. The assigned file needs to be downloaded from Canvas and the path updated.
